...
<head>
    <base href="{{asset('/dist/admin/cssLoginAdmin')}}/">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Web SAIGON_ACT| Log in</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
           ...
           <a href="index2.html"><b>LOGIN </b> SAIGON_ACT</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form role="form" method="post" action="{{ route('authenticate') }}">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-5">
                            <button type="submit" name="submit" value="Login" class="btn btn-primary" style="white-space: nowrap;">  <i class=" fas fa-check"></i> Đăng nhập</button>
                            @csrf
                        </div>
                        <!-- /.col -->
                    </div>
