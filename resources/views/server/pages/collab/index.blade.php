                                ...
                                <div class="input-group input-group-sm">
                                    <form action="{{ route('admin.collab.show', [$khoa['slug']]) }}" method="get">
                                        <select class="form-control custon-select" style="width:auto !important" data-toggle="tooltip" name="item-per-page" onchange="this.parentElement.submit();">
                                            <option value="6" {{ $collab_list->perPage() == 6 ? 'selected disabled' : ''  }}>Hiện 6 mục</option>
                                            <option value="9" {{ $collab_list->perPage() == 9 ? 'selected disabled' : ''  }}>Hiện 9 mục</option>
                                            <option value="12" {{ $collab_list->perPage() == 12 ? 'selected disabled' : ''  }}>Hiện 12 mục</option>
                                        </select>
                                    </form>
                                </div>
                            </div>
                                        ...
                                        <div class="card bg-light">
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="row">
                                                    <div class="col-7">
                                                        ...
                                                        <p class="text-muted text-sm"><b>Tạo ngày : </b> {{ ConvertDatabaseTimeToDMY($collab['created_at']) }} </p>
                                                    ...
                                                    <div class="col-5 text-center">
                                                        <img src="{{asset($collab->image_url ?? "dist/img/imgdefault.png")}}" alt="sdfsdf"
                                            ...
                                            <div class="card-footer">
                                                <div class="text-right">
                                                    <a href="{{ route('admin.collab.edit', [$khoa['slug'], $collab['id']]) }}" class="btn btn-sm bg-teal">
                                                        <i class="fas fa-user-edit"></i> Sửa
                                                    </a>
                                                    <a href="{{ route('admin.collab.delete', [$khoa['slug'], $collab['id']]) }}" class="btn btn-sm btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa !')">
                                ...
                                <div class="row">
                                    <div class="col-sm-5 hidden-xs">
                                        <div class="dataTables_info" id="example-datatable_info" role="status" aria-live="polite">
                                            <strong>Trang {{ $collab_list->currentPage() }} / {{ $collab_list->lastPage() }}</strong>
                                        </div>
                                    </div>
