                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Slug : </label>
                                            <input required type="text" id="slug" name="slug" value="{{ old('slug') }}"
                                                class="form-control" placeholder="Slug...">
                                        </div>
                                        <div class="form-group">
                                            <label>Meta Từ Khóa : </label>
                                            <input required type="text" id="keywords" name="keywords"
                                                value="{{ old('keywords') }}" class="form-control"
                                                placeholder="Nhập Meta Keywords...">
                                        </div>
                                        <div class="form-group">
                                            <label>Meta Mô tả : </label>
                                            <input required type="text" id="descriptions" name="descriptions"
                                                value="{{ old('descriptions') }}" class="form-control"
                                                placeholder="Nhập Meta Descriptions...">
                                        </div>

                                        <div class="form-group">
                                            <label>Tên Layout : </label>
                                            <input required type="text" id="layoutname" name="layout_name"
                                                value="{{ old('layout_name') }}" class="form-control"
                                                placeholder="Nhập tên layout...">
                                        </div>

                                        <div class="form-group">
                                            <label>Trang Layout : </label>
                                            <input required type="text" id="layoutpage" name="layout_page"
                                                value="{{ old('layout_page') }}" class="form-control"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea required class="ckeditor" required name="introdution"
                                                id="introdution">{{ old('introdution') }}</textarea>
