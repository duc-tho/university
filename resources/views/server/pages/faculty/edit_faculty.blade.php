                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="date" id="created_by" name="created_by"  value="{{$faculty->created_by}}" class="form-control" placeholder="Nhập trang layout...">
                                    </div>

                                    <div class="form-group">
                                        <label>Ngày Đăng : </label>
                                        <input required type="date" id="updated_by" name="updated_by"  value="{{$faculty->updated_by}}" class="form-control" placeholder="Nhập trang layout...">
                                    </div>
                                </div>
                            </div>
                        </div>
