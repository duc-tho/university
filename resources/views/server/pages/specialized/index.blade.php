                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                                        <div class="card bg-light">
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="row">
                                                    <div class="col-7">
                                                        <h2 class="lead"><b>{{$specialized->name}}</b></h2>
                                                        <p class="text-muted text-sm"><b>Tạo ngày : </b> {{ ConvertDatabaseTimeToDMY($specialized['created_at']) }} </p>
                                                    ...
                                                    <div class="col-5 text-center">
                                                        <img src="{{asset($specialized->image ?? "dist/img/imgdefault.png")}}" alt="sdfsdf"
                                            ...
                                            <div class="card-footer">
                                                <div class="text-right">
                                                    <a href="{{ route('admin.specialized.edit', [$khoa['slug'], $specialized['id']]) }}" class="btn btn-sm bg-teal">
                                                        <i class="fas fa-user-edit"></i> Sửa
                                                    </a>
                                                    <a href="{{ route('admin.specialized.delete', [$khoa['slug'], $specialized['id']]) }}" class="btn btn-sm btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa !')">
                                ...
                                <div class="row">
                                    <div class="col-sm-5 hidden-xs">
                                        <div class="dataTables_info" id="example-datatable_info" role="status" aria-live="polite">
                                            <strong>Trang {{ $specialized_list->currentPage() }} / {{ $specialized_list->lastPage() }}</strong>
                                        </div>
                                    </div>
