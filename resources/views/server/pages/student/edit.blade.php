    ...
    <div class="col-sm-12 px-3">
        <x-admin.form.form method="POST" :cancelLink="route('admin.student.show', [$khoa['slug']])" :submitLink="route('admin.student.update', [$khoa['slug'], $student['id']])">
            <div class="row">
                ...
                <x-admin.form.input :data="$student" :col="3" :type="'text'" :label="'Người Cập Nhập'" :required="true" :placeholder="'Người Cập Nhập'" :fieldName="'updated_by'" />
                ...
                <x-admin.form.multi-select :data="$student" :col="6" :label="'Vai trò'" :required="false" :fieldName="'role'">
