        ...
        <div class="col-sm-12 px-3">
            <x-admin.form.form method="POST" :cancelLink="route('admin.category.show', [$khoa['slug']])"
                ...
                <div class="row">
                    ...
                    <x-admin.form.checkbox :col="3" :label="'Hiển thị ở Trang Chủ'" :required="true" :fieldName="'show_at_home'"
                    :labelContent="'Đang hoạt động'" />

                    <x-admin.form.checkbox :col="3" :label="'Hiển thị ở Trang Tin Tức'" :required="true" :fieldName="'show_at_news'"
                    :labelContent="'Đang hoạt động'" />

                    <x-admin.form.checkbox :col="3" :label="'Hiển thị ở Trang Thông Báo'" :required="true" :fieldName="'show_at_notification'"
                    :labelContent="'Đang hoạt động'" />
