    ...
    <div class="row">
        <div class="col-sm-12 px-3">
            <x-admin.form.form method="POST" :cancelLink="route('admin.category.show', [$khoa['slug']])"
                :submitLink="route('admin.category.update', [$khoa['slug'],$category['id']])">
                <div class="row">
                    ...
                    <x-admin.form.input :data="$category" :col="3" :type="'text'" :label="'Slug danh mục'" :required="true"
                        :placeholder="'Slug danh mục'" :fieldName="'slug'" />

                    <x-admin.form.input :data="$category" :col="3" :type="'text'" :label="'Meta Descriptions'"
                        :required="true" :placeholder="'Meta Descriptions'" :fieldName="'meta_descriptions'" />

                    <x-admin.form.input :data="$category" :col="3" :type="'text'" :label="'Meta Keywords'" :required="true"
