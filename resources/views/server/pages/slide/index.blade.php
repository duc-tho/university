                                ...
                                <div class="input-group input-group-sm">
                                    <form action="{{ route('admin.slide.show', [$khoa['slug']]) }}" method="get">
                                        <select class="form-control custon-select" style="width:auto !important"
                                            ...
                                            <option value="6"
                                                {{ $slide_list->perPage() == 6 ? 'selected disabled' : '' }}>Hiện 6 mục
                                            </option>
                                            <option value="9"
                                                {{ $slide_list->perPage() == 9 ? 'selected disabled' : '' }}>Hiện 9 mục
                                            </option>
                                            <option value="12"
                                                {{ $slide_list->perPage() == 12 ? 'selected disabled' : '' }}>Hiện 12 mục
                                            </option>
                                        </select>
                                    </form>
                                </div>
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                                        <div class="card bg-light">
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="row">
                                                    <div class="col-7">
                                                        <h2 class="lead text-max"><b>{{ $slide->name }}</b></h2>
                                                        <p class="text-muted text-sm text-max"><b>Tạo ngày : </b>
                                                            {{ ConvertDatabaseTimeToDMY($slide['created_at']) }} </p>
                                                    ...
                                                    <div class="col-5 text-center">
                                                        <img src="{{ asset($slide->link ?? 'dist/img/imgdefault.png') }}"
                                            ...
                                            <div class="card-footer">
                                                <div class="text-right">
                                                    <a href="{{ route('admin.slide.edit', [$khoa['slug'], $slide['id']]) }}"
                                                        class="btn btn-sm bg-teal">
                                                        <i class="fas fa-user-edit"></i> Sửa
                                                    </a>
                                                    <a href="{{ route('admin.slide.delete', [$khoa['slug'], $slide['id']]) }}"
                            ...
                            <div class="row">
                                <div class="col-sm-5 hidden-xs">
                                    <div class="dataTables_info" id="example-datatable_info" role="status"
                                        aria-live="polite">
                                        <strong>Trang {{ $slide_list->currentPage() }} /
                                            {{ $slide_list->lastPage() }}</strong>
                                    </div>
                                </div>
