                                ...
                                <div class="container">
                                    <div class="banner-info-bg mx-auto text-center">
                                        ...
                                        <a class="btn btn-secondary btn-theme2 mt-md-5 mt-4"
                                            href="{{ route('gioithieu') }}">Tìm Hiểu</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="middle-section grid-column text-center">
                    <div class="three-grids-columns">
                        ...
                        <p>Quản trị khách sạn là quản lý và tổ chức các hoạt động của khách sạn sao cho hiệu quả và hợp lý
                            nhất.
                        </p>
            ...
            <div class="container py-md-3">
                ...
                <div class="calltoaction-20-content row">
                    <div class="column center-align-self col-lg-6 pr-lg-5">
                        ...
                        <p class="more-gap editContent">Khoa du lịch của trường đã và đang lại đại diện nghành có tỉ lệ sinh
                            viên
                    ...
                    <div class="column ccont-left col-lg-6">
                        <img src="{{ asset('dist/layout/layout_khoadulich/images/20181227183820-68860.png') }}"
                ...
                <div class="grid grid-column-2 ">
                    ...
                    <div class="column1">
                        <div class="heading">
                            ...
                            <p class="my-3 text-white">Năm 2016, Khoa Du Lịch đã đạt tỉ lệ sinh viên tham gia học ở khoa lớn
                                nhất
                                trường
                ...
                <div class="section-title align-center row">
                    <div class="item-top col-md-6 pr-md-5">
                        <div class="heading">
                            ...
                            <p class="my-3 head text-white">Được đông đảo sinh viên tham gia nhiệt tình hăng hái, khoa du
                                lịch đã và
                                đang phát triển ngày càng
                                mạnh mẽ, và tiềm năng càng phát triển khi là khoa chủ đạo là nghành chủ đạo của trường
                            </p>
                            <p class="my-3 head text-white"> Được sự quan tâm của các bạn trẻ, khoa du lịch cũng như trường
                                luôn tiếp
                                đón các ý kiến
                    ...
                    <div class="item-top col-md-6 mt-md-0 mt-4">
                        <div class="item text-center">
                            <div class="imgTitle">
                                <img src="{{ asset('dist/layout/layout_khoadulich/images/c3.jpg') }}" class="img-responsive"
                                    alt="" />
                            </div>
                            <h6 class="mt-3">Nguyễn Lưu Vân Anh</h6>
                            <p class="">Cựu Sinh Viên Của Trường</p>
                            <p> Khoa du lịch đã cho tôi những trải nghiệm về 4 năm sinh viên thật tuyệt vời, được tận hưởng
                                niềm vui
                    ...
                    <div class="pricing-chart col-lg-6">
                        ...
                        <div class="tatest-top mt-md-5 mt-4">
                            <div class="price-box btn-layout bt6">
                                <div class="grid grid-column-2">
                                    <div class="column-6">
                                        <img src="{{ asset('dist/layout/layout_khoadulich/images/20170828170500-78971.jpg') }}"
                                            alt="" class="img-fluid">
                                    </div>
                                    <div class="column1">
                                        <div class="job-info">
                            ...
                            <div class="price-box btn-layout bt6">
                                <div class="grid grid-column-2">
                                    <div class="column-6">
                                        <img src="{{ asset('dist/layout/layout_khoadulich/images/20180118145548-56466.jpg') }}"
                                            alt="" class="img-fluid">
                                    </div>
                                    <div class="column1">
                            ...
                            <div class="price-box btn-layout bt6">
                                <div class="grid grid-column-2">
                                    <div class="column-6">
                                        <img src="{{ asset('dist/layout/layout_khoadulich/images/5.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                    <div class="column1">
