...
@section('title','Ngành QTNHvDVAU')
@section('main')
<section class="w3l-about-breadcrum">
    <div class="breadcrum-bg py-sm-5 py-4">
      <div class="container py-lg-3">
        <h2>Ngành Quản Trị Nhà Hàng Và Dịch Vụ Ăn Uống</h2>
        <p><a href="{{route('khoadulich')}}">Trang Chủ</a> &nbsp; / &nbsp; Đào Tạo &nbsp; / &nbsp; Nghành Quản Trị Nhà Hàng và Dịch Vụ Ăn Uống</p>
      </div>
    </div>
  </section>
