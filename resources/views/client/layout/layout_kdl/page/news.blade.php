            ...
            <div class="fea-gd-vv text-center row">
              ...
              <h6> <span id=" sernew">Tin tức,</span> tháng 6/24/2020</h6>
                ...
                <div class="float-top col-lg-4 col-md-6 mt-md-0 mt-5">
                    <a href="{{route('chitiettintuc')}}"><img src="{{asset('dist/layout/layout_khoadulich/images/gioi-thieu-khoa-hoc-ngan-han-nghiep-vu-le-tan-thumbnail-61683.jpg')}}" class="img-responsive" alt=""></a>
                    <div class="float-lt feature-gd">
                        <h3><a href="{{route('chitiettintuc')}}">Chiêu sinh khoá học Nghiệp vụ Batender</a> </h3>
                        <h6> <span id="sernew">Tin tức,</span> tháng 6/24/2020</h6>
                ...
                <div class="float-top col-lg-4 col-md-6 mt-lg-0 mt-5">
                    <a href="{{route('chitiettintuc')}}"><img src="{{asset('dist/layout/layout_khoadulich/images/chieu-sinh-khoa-hoc-nghiep-vu-batender-thumbnail-24046.jpg')}}" class="img-responsive" alt=""></a>

                    <div class="float-lt feature-gd">
                        <h3><a href="{{route('chitiettintuc')}}"> Nghiệp Vụ Lễ Tân, Nghiệp Vụ Phục Vụ Khách Sạn</a> </h3>
                        <h6> <span id="sernew">Tin tức,</span> tháng 6/24/2020</h6>
                ...
                <div class="float-top col-lg-4 col-md-6 mt-5">
                    <a href="{{route('chitiettintuc')}}"><img src="{{asset('dist/layout/layout_khoadulich/images/20180118150548-73629.jpg')}}" class="img-responsive" alt=""></a>

                    <div class="float-lt feature-gd">
                        <h3><a href="{{route('chitiettintuc')}}">Giới thiệu khoá học ngắn hạn Nghiệp vụ phục vụ bàn nhà hàng khách sạnc</a> </h3>
                ...
                <div class="float-top col-lg-4 col-md-6 mt-5">
                    ...
                    <div class="float-lt feature-gd">
                        <h3><a href="{{route('chitiettintuc')}}">SAIGONACT chiêu sinh các lớp học ngắn hạn Du lịch</a> </h3>
                ...
                <div class="float-top col-lg-4 col-md-6 mt-5">
                    ...
                    <div class="float-lt feature-gd">
                        <h3><a href="{{route('chitiettintuc')}}">Kết nối để thành công để trao yêu thương</a> </h3>
                        {{-- <h3><a href="javascript:">Analysis of Principal</a> </h3> --}}
