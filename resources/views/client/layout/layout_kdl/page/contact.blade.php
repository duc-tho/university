...
<section class="w3l-contact-breadcrum">
    <div class="breadcrum-bg py-sm-5 py-4">
        <div class="container py-lg-3">
            <h2>Liên Hệ</h2>
            <p><a href="{{route('khoadulich')}}">Trang Chủ</a> &nbsp; / &nbsp; Liên Hệ</p>
        </div>
    </div>
</section>
<!-- contact -->
                    ...
                    <div class="cont-subs">
                        <div class="cont-add">
                            ...
                            <div class="cont-add-rgt">
                                <h4>Địa Chỉ :</h4>
                                <p class="contact-text-sub">Khoa Du lịch - Lầu 1
                                    Cơ sở 2: 53/1 Phan Văn Hớn, Đường Tân Thới Nhất 8, Khu phố 5, P.Tân Thới Nhất, Q.12-Tp.HCM.</p>
                            </div>
                        ...
                        <div class="cont-add add-2">
                            ...
                            <div class="cont-add-rgt">
                                ...
                                <a href="mailto:info@example.com">
                                    <p class="contact-text-sub">khoadulich@daihocdulich.edu.vn</p>
                                </a>
                            </div>
                            <div class="cont-add-lft">
                        ...
                        <div class="cont-add">
                            ...
                            <div class="cont-add-rgt">
                                ...
                                <a href="tel:+7-800-999-800">
                                    <p class="contact-text-sub"> (028) 628 614 62</p>
                                </a>
                            </div>
                            <div class="cont-add-lft">
