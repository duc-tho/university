            ...
            <div class="wthree_agile_login">
                <ul>
                    ...
                    <li><i class="fa fa-envelope-o list-icon" aria-hidden="true"></i><a
                            href="mailto:info@daihocdulich.com">{{ $email }}</a></li>
                </ul>
            </div>
...
<div class="clearfix"></div>
        ...
        <div style="display: flex; justify-content: center; padding-top: 3em;"><a class="btn1" href="{{ $intro_route }}">
                Tìm hiểu thêm</a></div>
    </div>
    <!-- //about -->
    <!--services-->
    ...
    <div class="wthree-testi w3ls-section" id="testimonials">
        ...
        <div class="container">
            ...
            <div class="w3_wthree-testi_grids text-center">
                ...
                <div style="display: flex; justify-content: center; padding-top: 3em;"><a class="btn1"
                        href="{{ route('giao-vien', [$faculty['slug']]) }}"> Cán Bộ Giảng Viên</a></div>
            </div>
        </div>
    </div>
    <!-- //testimonial -->
...
<div class="clearfix"></div>
        ...
        <div class="col-md-6 col-sm-6  col-xs-6 agileits_w3layouts-map">
            <iframe src="{{ $ggmap }}" style="border:0;" allowfullscreen></iframe>
        </div>
