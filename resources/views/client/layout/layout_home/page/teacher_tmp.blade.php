    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <h2><i class="fa fa-address-card bg-pink"></i>Danh Sách Giảng Viên Các Khoa <small class="hidden-xs-down hidden-sm-down">06/01/2021</small></h2>
            </div><!-- end col -->
            <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('gioi-thieu-chi-tiet', ['trang-chu', 'gioi-thieu-chi-tiet']) }}">Trang
                            chủ</a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <img src="{{ asset('dist/layout/default/images/t1.jpg') }}" class="w3-circle" alt="Avatar" style="width:100%">
                                        </div>
                                        <br>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <img src="{{ asset('dist/layout/default/images/t-1.jpg') }}" class="w3-circle" alt="Avatar" style="width:100%">
                                        </div>
                                        <br>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <img src="{{ asset('dist/layout/default/images/t2.jpg') }}" class="w3-circle" alt="Avatar" style="width:100%">
                                        </div>
                                        <br>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <img src="{{ asset('dist/layout/default/images/t-2.jpg') }}" class="w3-circle" alt="Avatar" style="width:100%">
                                        </div>
                                        <br>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <img src="{{ asset('dist/layout/default/images/t3.jpg') }}" class="w3-circle" alt="Avatar" style="width:100%">
                                        </div>
                                        <br>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <img src="{{ asset('dist/layout/default/images/t-3.jpg') }}" class="w3-circle" alt="Avatar" style="width:100%">
                                        </div>
                                        <br>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <img src="{{ asset('dist/layout/default/images/t4.jpg') }}" class="w3-circle" alt="Avatar" style="width:100%">
                                        </div>
                                        <br>
