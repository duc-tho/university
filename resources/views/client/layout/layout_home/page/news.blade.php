            ...
            <div class="masonry-blog clearfix">
                <div class="left-side">
                    <div class="masonry-box post-media">
                        <img src="http://daihocdulich.edu.vn/upload/news/2020/09/11/tu-nguyen-va-dia-danh-thumbnail-55623.jpg"
                            alt="" class="img-fluid">
                        <div class="shadoweffect">
                            <div class="shadow-desc">
                                <div class="blog-meta">
                                    <span class="bg-aqua"><a
                                            href="{{ route('tin-tuc-danh-muc', ['trang-chu', 'tin-tuc-danh-muc']) }}"
                                            title="">Nghiên cứu</a></span>
                                    <h4><a href="{{ route('tin-tuc-chi-tiet', ['trang-chu', 'tin-tuc-danh-muc', 'chi-tiet-tin-tuc']) }}"
                                            title="">"Từ nguyên" và "Địa danh"</a>
                                    </h4>
                                    <small><a
                                            href="{{ route('tin-tuc-chi-tiet', ['trang-chu', 'tin-tuc-danh-muc', 'chi-tiet-tin-tuc']) }}"
                                            title="">Đăng ngày 21/12/2020
                                        </a></small>
                                    <small><a href="blog-author.html" title="">bởi
                                            Mei Misaki</a></small>
                                </div><!-- end meta -->
                            </div><!-- end shadow-desc -->
                        </div><!-- end shadow -->
                    ...
                    <div class="masonry-box small-box post-media">
                        <img src="http://daihocdulich.edu.vn/upload/news/2020/11/22/chuong-trinh-cao-dang-9-danh-cho-hoc-sinh-sau-thcs-thumbnail-81546.jpg"
                            alt="" class="img-fluid">
                        <div class="shadoweffect">
                            <div class="shadow-desc">
                                <div class="blog-meta">
                                    <span class="bg-green"><a
                                            href="{{ route('tin-tuc-danh-muc', ['trang-chu', 'tin-tuc-danh-muc']) }}"
                                            title="">Tuyển sinh</a></span>
                                    <h4><a href="{{ route('tin-tuc-chi-tiet', ['trang-chu', 'tin-tuc-danh-muc', 'chi-tiet-tin-tuc']) }}"
                                            title="">Lộ trình đào tạo 9 + tại Trường
                                            Saigonact</a></h4>
                                </div><!-- end meta -->
                            </div><!-- end shadow-desc -->
                        </div><!-- end shadow -->
                    ...
                    <div class="masonry-box small-box post-media">
                        <img src="http://daihocdulich.edu.vn/upload/news/2020/10/21/chuong-trinh-hoc-9-loi-the-cua-gioi-tre-thoi-40-thumbnail-15001.jpg"
                            alt="" class="img-fluid">
                        <div class="shadoweffect">
                            <div class="shadow-desc">
                                <div class="blog-meta">
                                    <span class="bg-green"><a
                                            ...
                                            title="">Tuyển sinh</a></span>
                                    <h4><a href="{{ route('tin-tuc-chi-tiet', ['trang-chu', 'tin-tuc-danh-muc', 'chi-tiet-tin-tuc']) }}"
                                            title="">Chương trình học 9 +: Lợi thế
                                            của giới trẻ thời 4.0</a></h4>
                                </div><!-- end meta -->
                            </div><!-- end shadow-desc -->
                        </div><!-- end shadow -->
                    </div><!-- end post-media -->
                ...
                <div class="center-side">
                    <div class="masonry-box post-media">
                        <img src="http://daihocdulich.edu.vn/upload/news/2020/11/11/lo-trinh-dao-tao-9-tai-truong-act-thumbnail-57260.jpg"
                            alt="" class="img-fluid">
                        <div class="shadoweffect">
                            <div class="shadow-desc">
                                <div class="blog-meta">
                                    <span class="bg-green"><a
                                            ...
                                            title="">Tuyển sinh</a></span>
                                    <h4><a href="{{ route('tin-tuc-chi-tiet', ['trang-chu', 'tin-tuc-danh-muc', 'chi-tiet-tin-tuc']) }}"
                                            title="">CHƯƠNG TRÌNH CAO ĐẲNG 9+ DÀNH
                                            CHO HỌC SINH SAU THCS</a></h4>
                                    <small><a
                                            href="{{ route('tin-tuc-chi-tiet', ['trang-chu', 'tin-tuc-danh-muc', 'chi-tiet-tin-tuc']) }}"
                                            title="">Đăng ngày
                                            21/12/2020</a></small>
                ...
                <div class="right-side hidden-md-down">
                    <div class="masonry-box post-media">
                        <img src="http://daihocdulich.edu.vn/upload/news/2020/10/04/lanh-dao-nha-truong-thumbnail-53550.jpg"
                            alt="" class="img-fluid">
                        <div class="shadoweffect">
                            <div class="shadow-desc">
                                <div class="blog-meta">
                                    <span class="bg-aqua"><a
                                            href="{{ route('tin-tuc-danh-muc', ['trang-chu', 'tin-tuc-danh-muc']) }}"
                                            title="">Giới thiệu</a></span>
                                    <h4><a href="{{ route('tin-tuc-chi-tiet', ['trang-chu', 'tin-tuc-danh-muc', 'chi-tiet-tin-tuc']) }}"
                                            title="">Saigonact – địa chỉ uy tín với
                                            hệ thống cơ sở vật chất hiện đại</a>
                                    </h4>
                                    <small><a
                                            href="{{ route('tin-tuc-chi-tiet', ['trang-chu', 'tin-tuc-danh-muc', 'chi-tiet-tin-tuc']) }}"
                                            title="">Đăng ngày
