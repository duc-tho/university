            ...
            <div class="faq-list">
                <ul>
                    ...
                    <li data-aos="fade-up" data-aos-delay="100">
                        <i class="bx bx-help-circle icon-help" id="bx"></i> <a data-toggle="collapse" href="#faq-list-2" class="collapsed">Hồ sơ tuyển sinh cần những giấy tờ nào quan trọng nhất ? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                    ...
                    <li data-aos="fade-up" data-aos-delay="200">
                        <i class="bx bx-help-circle icon-help" id="bx"></i> <a data-toggle="collapse" href="#faq-list-3" class="collapsed">Học phí, học bổng giành cho các đối tượng đặc biệt ?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                    ...
                    <li data-aos="fade-up" data-aos-delay="300">
                        <i class="bx bx-help-circle icon-help" id="bx"></i> <a data-toggle="collapse" href="#faq-list-4" class="collapsed">Hỗ trợ từ phía nhà trường đối với các trường hợp đặc biệt (mồ côi,
                            con thương binh) ? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                    ...
                    <li data-aos="fade-up" data-aos-delay="400">
                        <i class="bx bx-help-circle icon-help" id="bx"></i> <a data-toggle="collapse" href="#faq-list-5" class="collapsed">Làm cách nào để biết thông báo trúng tuyển từ phía nhà trường ?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
