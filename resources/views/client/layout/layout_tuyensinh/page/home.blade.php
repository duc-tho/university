                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-5" data-aos="fade-up">
                        <div class="content">
                            ...
                            <p class="p-card-banner">Tư vấn trực tuyến 24/7 : <span
                                    class="span-card-banner">daihocdulich.edu.vn/tu-van</span> </p>
                            <p class="p-card-banner">Nhận và nộp hồ sơ xét tuyển trực tuyến tại : <span
                                    class="span-card-banner">daihocdulich.edu.vn/xet-tuyen</span> </p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                        <div class="card"
                            style="background-image: url({{ asset('dist/layout/layout_tuyensinh/img/values-1.jpg') }});">
                            <div class="card-body">
                                <h5 class="card-title"><a>Danh Sách Sinh Viên Trúng Tuyển</a></h5>
                                <p class="card-text">Danh sách trúng tuyển năm 2020 của Trường Cao Đẳng Văn Hóa Nghệ Thuật
                                    Và Du Lịch
                                    Sài Gòn</p>
                                <div class="read-more"><a href="{{ route('chitietthongbaotuyensinh') }}"><i
                    ...
                    <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="100">
                        <div class="card"
                            style="background-image: url({{ asset('dist/layout/layout_tuyensinh/img/values-2.jpg') }});">
                            <div class="card-body">
                                <h5 class="card-title"><a href="">Kế Hoạch Tuyển Sinh Của Trường Năm 2021</a></h5>
                                <p class="card-text">Danh sách các nghành đào tạo, phương thức tuyển sinh, kế hoạch năm học
                                    2021</p>
                                <div class="read-more"><a href="{{ route('chitietthongbaotuyensinh') }}"><i
                                            class="icofont-arrow-right"></i> Đọc Thêm</a></div>
                            </div>
                    ...
                    <div class="col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="card"
                            style="background-image: url({{ asset('dist/layout/layout_tuyensinh/img/values-3.jpg') }});">
                            <div class="card-body">
                                <h5 class="card-title"><a href="">Thông Tin Tuyển Sinh Cao Đẳng Hệ 2 Năm, Trung Cấp Chuyên
                                        Nghiệp Năm
                                        2021</a></h5>
                                <p class="card-text">Nhóm ngành đào tạo: du lịch, ngoại ngữ, công nghệ thông tin, kỹ thuật
                                    (xét
                                    tuyển)...</p>
                                <div class="read-more"><a href="{{ route('thongbaotuyensinh') }}"><i
                                            class="icofont-arrow-right"></i> Đọc Thêm</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="300">
                        <div class="card"
                            style="background-image: url({{ asset('dist/layout/layout_tuyensinh/img/values-4.jpg') }});">
                            <div class="card-body">
                                <h5 class="card-title"><a href="">Chế Độ Học Bổng Khi Tham Gia Tuyển Sinh Của Nhà Trường Năm
                                        2021</a>
                                </h5>
                    ...
                    <div class="col-lg-12 center-button-add">
                        <br>
                        <a href="{{ route('thongbaotuyensinh') }}"> <button class="button"><span>Xem Thêm
                                </span></button></a>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <p data-aos="fade-up" id="suppo">Chúng tôi luôn sẵn sàng giúp đỡ các sinh viên có mong muốn đăng kí
                        ...
                        giải quyết các thắc mắc cho sinh viên vào các khung giờ hành chính trực tuyến 24/7 hoặc thông qua
                        thông tin
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('dist/layout/layout_tuyensinh/img/team/team-1.jpg') }}"
                                    class="img-fluid" alt="">
                                <div class="social">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('dist/layout/layout_tuyensinh/img/team/team-2.jpg') }}"
                                    class="img-fluid" alt="">
                                <div class="social">
                                    <a href=""><i class="icofont-twitter"></i></a>
                                    <a href=""><i class="icofont-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('dist/layout/layout_tuyensinh/img/team/team-3.jpg') }}"
                                    class="img-fluid" alt="">
                                <div class="social">
                                    <a href=""><i class="icofont-twitter"></i></a>
                                    <a href=""><i class="icofont-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('dist/layout/layout_tuyensinh/img/team/team-4.jpg') }}"
                                    class="img-fluid" alt="">
                                <div class="social">
                                    <a href=""><i class="icofont-twitter"></i></a>
                                    <a href=""><i class="icofont-facebook"></i></a>
        ...
        <section id="faq" class="faq section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <p data-aos="fade-up" id="fade">Những thắc mắc của sinh viên, phụ huynh khi tham gia đăng kí xét tuyển,
                        cũng
                        như những
                    ...
                    <ul>
                        <li data-aos="fade-up">
                            <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" class="collapse"
                                ...
                                nào ? <i class="bx bx-chevron-down icon-show"></i><i
                                    class="bx bx-chevron-up icon-close"></i></a>
                            <div id="faq-list-1" class="collapse show" data-parent=".faq-list">
                                <p>
                                    Nhà trường sẽ tổ chứ tuyển sinh gồm 3 đợt, mỗi đợt sẽ có những chỉ tiêu riêng và sẽ có
                                    thông báo sau
                                </p>
                            </div>
                        </li>
                        ...
                        <li data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div id="faq-list-2" class="collapse" data-parent=".faq-list">
                                <p>
                                    Phiếu đăng ký xét tuyển (Mẫu của trường),Bảng sao Học Bạ có công chứng, 03 thẻ ảnh 3x4,
                        ...
                        <li data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div id="faq-list-3" class="collapse" data-parent=".faq-list">
                                <p>
                                    Nhà trường luôn có những học bổng đặc biệt cho các tân sinh viên, và sinh viên sẽ được
                                    hưởng học bổng theo đúng chế độ mà nhà trường đặt ra
                                </p>
                            </div>
                        </li>
                        ...
                        <li data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div id="faq-list-4" class="collapse" data-parent=".faq-list">
                                <p>
                                    Nhà trường luôn hỗ trợ cho những sinh viên có hoàn cảnh khó khăn trong hoàn cảnh, và nhà
                                    trường sẽ khen thưởng cho những sinh viên có thành tích tốt mà có hoàn cảnh khóa khăn.
                                </p>
                            </div>
                        </li>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 form-group">
                                    <input type="text" class="form-control" name="address" id="address" placeholder="Địa Chỉ"
                                        data-rule="minlen:4"  data-msg="Bạn chưa điền địa chỉ" />
                                    <div class="validate"></div>
                                </div>
                            </div>
                            <div class="form-row">
