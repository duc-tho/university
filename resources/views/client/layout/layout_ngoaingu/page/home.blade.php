                    ...
                    <div class="carousel-item">
                        <div class="carousel-container">
                            <div class="carousel-content">
                                ...
                                <p class="animate__animated animate__fadeInUp">Best choice to learn at SaiGon University.</p>
                                <a href="javascript:" class="btn-get-started animate__animated animate__fadeInUp">Tìm hiểu thêm</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container proj-bottom">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 fh5co-project fadeIn animate-box animated-fast" data-animate-effect="fadeIn">
                            <a href="javascript:"><img src="http://khoangoaingu.daihocdulich.edu.vn/upload/news/2019/07/18/tieng-trung-quoc-nganh-hoc-chua-bao-gio-het-hot-thumbnail-44420.png" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
                                <h3>Tiếng Trung Quốc - Ngành học chưa bao giờ hết hot</h3>
                                <span>Xem chi tiết</span>
                            </a>
                        </div>
                        <div class="col-md-4 col-sm-6 fh5co-project fadeIn animate-box animated-fast" data-animate-effect="fadeIn">
                            <a href="javascript:"><img src="http://khoangoaingu.daihocdulich.edu.vn/upload/news/2019/05/30/tai-sao-nen-hoc-tieng-trung-thumbnail-67983.png" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
                        ...
                        <div class="col-md-4 col-sm-6 fh5co-project fadeIn animate-box animated-fast" data-animate-effect="fadeIn">
                            <a href="javascript:"><img src="http://khoangoaingu.daihocdulich.edu.vn/upload/news/2018/08/02/van-hoa-nhat-ban-thumbnail-52187.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
                                <h3>Văn hóa Nhật Bản</h3>
                                <span>Xem chi tiết</span>
                            </a>
                        </div>
                        <div class="col-md-4 col-sm-6 fh5co-project fadeIn animate-box animated-fast" data-animate-effect="fadeIn">
                            <a href="javascript:"><img src="http://khoangoaingu.daihocdulich.edu.vn/upload/news/2018/05/17/phuong-phap-hoc-ngoai-ngu-nhanh-va-hieu-qua-thumbnail-88759.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
                                <h3>Phương pháp học ngoại ngữ hiệu quả</h3>
                                <span>Xem chi tiết</span>
                            </a>
                        </div>
                        <div class="col-md-4 col-sm-6 fh5co-project fadeIn animate-box animated-fast" data-animate-effect="fadeIn">
                            <a href="javascript:"><img src="http://khoangoaingu.daihocdulich.edu.vn/upload/news/2017/09/14/cu-nhan-nganh-tieng-nhat-khong-so-that-nghiep-thumbnail-23520.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                        <div class="icon-box">
                            ...
                            <h4><a href="javascript:">Magni Dolores</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                        <div class="icon-box">
                            ...
                            <h4><a href="javascript:">Dele cardo</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                        <div class="icon-box">
                            ...
                            <h4><a href="javascript:">Divera don</a></h4>
