        ...
        <ul>
          ...
          <li class="drop-down"><a> Giới thiệu</a>
            <ul>
              ...
              <li class="drop-down"><a href="#">Đội ngũ giảng viên</a>
                <ul>
          ...
          <li class="drop-down"><a> Sinh viên</a>
            <ul>
              ...
              <li><a href="team.html">Công tác đoàn</a></li>
              <li><a href="about.html">Cựu sinh viên</a></li>
              <li><a href="team.html">Học bổng</a></li>
              <li><a href="about.html">Học tập</a></li>
              <li><a href="about.html">Câu lạc bộ</a></li>
              <li><a href="team.html">Việc làm thêm</a></li>
            </ul>
          </li>

          <li><a href="{{route('tintucngoaingu')}}">Tin tức - Sự kiện</a></li>
          {{-- <li class="drop-down"><a href="#">Bảng viên</a>
            <ul>
