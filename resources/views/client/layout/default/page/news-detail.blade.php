            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div class="page-wrapper">
                    ...
                    <div class="single-post-media">
                        <img src="{{ asset('dist/layout/default/upload/menu_08.jpg') }}" alt="" class="img-fluid">
                    </div><!-- end media -->
                    ...
                    <div class="blog-content">
                        <div class="pp">
                            ...
                            <p>Vivamus non condimentum orci. Pellentesque venenatis nibh sit amet est vehicula lobortis. Cras eget aliquet eros. Nunc lectus elit, suscipit at nunc sed, finibus imperdiet ipsum. Maecenas dapibus neque sodales nulla finibus volutpat. Integer pulvinar massa vitae ultrices posuere. Proin ut tempor turpis. Mauris felis neque, egestas in lobortis et, sodales non ante. Ut vestibulum libero quis luctus tempus. Nullam eget dignissim massa. Vivamus id condimentum
                                orci. Nunc ac sem urna. Aliquam et hendrerit nisl massa nunc. </p>

                        </div><!-- end pp -->

                        <img src="{{ asset('dist/layout/default/upload/menu_05.jpg') }}" alt="" class="img-fluid img-fullwidth">
                                    ...
                                    <div class="list-group">
                                        <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                            <div class="w-100 justify-content-between text-right">
                                                <img src="{{ asset('dist/layout/default/upload/blog_square_02.jpg') }}" alt="" class="img-fluid float-right">
                    ...
                    <div class="custombox authorbox clearfix">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <img src="{{ asset('dist/layout/default/upload/author.jpg') }}" alt="" class="img-fluid rounded-circle">
                            </div><!-- end col -->
                        ...
                        <div class="row">
                                ...
                                <div class="blog-box">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="{{ asset('dist/layout/default/upload/menu_06.jpg') }}" alt="" class="img-fluid">
                            ...
                            <div class="col-lg-6">
                                <div class="blog-box">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="{{ asset('dist/layout/default/upload/menu_07.jpg') }}" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span class=""></span>
                                            </div><!-- end hover -->
                                        </a>
                                ...
                                <div class="comments-list">
                                    <div class="media">
                                        <a class="media-left" href="#">
                                            <img src="{{ asset('dist/layout/default/upload/author.jpg') }}" alt="" class="rounded-circle">
                                        </a>
                                    ...
                                    <div class="media">
                                        <a class="media-left" href="#">
                                            <img src="{{ asset('dist/layout/default/upload/author_01.jpg') }}" alt="" class="rounded-circle">
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <div class="media last-child">
                                        <a class="media-left" href="#">
                                            <img src="{{ asset('dist/layout/default/upload/author_02.jpg') }}" alt="" class="rounded-circle">
                                        </a>
                                        <div class="media-body">
