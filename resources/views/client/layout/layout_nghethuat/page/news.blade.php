                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="blog-box">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <h4 class="tittle_news"><a href="{{ route('khoanghethuat-chitiettintuc') }}" title="">Khoa Nghệ thuật ôm trọn bộ giải thưởng của ACT GOTTALENT 2019</a></h4>
                            ...
                            <div class="col-md-6">
                                <div class="blog-box">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <h4 class="tittle_news"><a href="{{ route('khoanghethuat-chitiettintuc') }}" title="">Nam luật sư bỏ nghề, theo “nghiệp” thiết kế</a></h4>
                            ...
                            <div class="col-md-6">
                                <div class="blog-box">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <h4 class="tittle_news"><a href="{{ route('khoanghethuat-chitiettintuc') }}" title="">Sinh viên ngành Diễn viên kịch nói và điện ảnh đầy ấn tượng và chuyên nghiệp trong bài thi cuối kỳ môn Múa và Hình thể</a></h4>
                            ...
                            <div class="col-md-6">
                                <div class="blog-box">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <h4 class="tittle_news"><a href="{{ route('khoanghethuat-chitiettintuc') }}" title="">Ngành Thiết kế đồ họa và sự lựa chọn hoàn hảo</a></h4>
                            ...
                            <div class="col-md-6">
                                <div class="blog-box">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <h4 class="tittle_news"><a href="{{ route('khoanghethuat-chitiettintuc') }}" title="">Học Đạo diễn sân khấu tại Trường Cao đẳng Văn hóa Nghệ thuật và Du lịch Sài Gòn</a></h4>
                            ...
                            <div class="col-md-6">
                                <div class="blog-box">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <h4 class="tittle_news"><a href="{{ route('khoanghethuat-chitiettintuc') }}" title="">Sức hút từ gian hàng tuyển sinh trường Cao đẳng Văn hóa Nghệ thuật và Du lịch Sài Gòn tại Cần Thơ</a></h4>
                            ...
                            <div class="col-md-6">
                                <div class="blog-box">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <h4 class="tittle_news"><a href="{{ route('khoanghethuat-chitiettintuc') }}" title="">Nghệ sỹ không còn là “Xướng ca vô loài”</a></h4>
                            ...
                            <div class="col-md-6">
                                <div class="blog-box">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <h4 class="tittle_news"><a href="{{ route('khoanghethuat-chitiettintuc') }}" title="">Lễ bảo vệ đồ án tốt nghiệp của sinh viên Khoa Nghệ thuật</a></h4>
                            ...
                            <div class="col-md-6">
                                <div class="blog-box">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <h4 class="tittle_news"><a href="{{ route('khoanghethuat-chitiettintuc') }}" title="">Học Thanh nhạc tại trường Saigonact và cơ hội việc làm</a></h4>
                            ...
                            <div class="col-md-6">
                                <div class="blog-box">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <h4 class="tittle_news"><a href="{{ route('khoanghethuat-chitiettintuc') }}" title="">Món quà ý nghĩa họp mặt đầu năm 2018 tại Saigonact</a></h4>
