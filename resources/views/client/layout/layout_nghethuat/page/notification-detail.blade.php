            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div class="page-wrapper">
                    <div class="blog-title-area">
                        ...
                        <span class="color-aqua"><a href="blog-category-01.html" title="">Thông báo</a></span>
                        <h3>Thông báo về việc triển khai đào tạo khóa 14 năm học 2019 - 2020</h3>
                        <div class="blog-meta big-meta">
                            <small><a href="single.html" title="">05/08/2019</a></small>
                    ...
                    <div class="blog-content">
                        ...
                        <p>Dưới sự quan tâm sâu sát của BGH Nhà trường, gần 10 năm qua Khoa đã hội tụ được một đội ngũ giảng viên dày dạn kinh nghiệm, được đào tạo chính quy trong và ngoài nước, có học hàm học vị cao, đó là các Giáo sư, Tiến sĩ, Thạc sĩ, NSND, NSƯT, và những chuyên gia đầu ngành giàu lòng nhiệt huyết đã đào tạo cho xã hội hàng trăm ca sĩ, diễn viên, đạo diễn và các Nhà Thiết kế Thời trang, Đồ họa có chất lượng cao. Nó như một dòng nước mát chảy dài trên mảnh đất ươm mầm những
                            tài năng Nghệ thuật cho đất nước trong hiện tại cũng như tương lai – BQLĐATL Trường Đại học Du lịch Sài Gòn.</p>
                        ...
                        <p><b>Thông báo Phòng Đào tạo</b></p> --}}
                        <img src="{{ asset('dist/layout/layout_nghethuat/images/hinh1_files/notice/tb1.png') }}" width="100%" height="100%">
                        <img src="{{ asset('dist/layout/layout_nghethuat/images/hinh1_files/notice/tb2.png') }}" width="100%" height="100%">
                    </div><!-- end content -->
                    <div class="blog-title-area">
