                        ...
                        <div class="col-lg-12">
                            <div class="banner-spot clearfix">
                                <div class="banner-img">
                                    <img src="{{ asset('dist/layout/layout_nghethuat/upload/banner_01.jpg') }}" alt="" class="img-fluid">
                                    <!-- <img src="http://khoanghethuat.daihocdulich.edu.vn/{{ asset('dist/layout/layout_nghethuat/upload/link/link-noi-that-g4-25281.png') }}" alt="" class="img-fluid imgbanner"> -->
                                </div><!-- end banner-img -->
                            </div><!-- end banner -->
                        </div><!-- end col -->
                    </div><!-- end row -->
                                    ...
                                    <div class="list-group">
                                        <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                            <div class="w-100 justify-content-between text-right">
                                                <img src="{{ asset('dist/layout/layout_nghethuat/upload/blog_square_02.jpg') }}" alt="" class="img-fluid float-right">
                    ...
                    <div class="custombox authorbox clearfix">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <img src="{{ asset('dist/layout/layout_nghethuat/upload/author.jpg') }}" alt="" class="img-fluid rounded-circle">
                            </div><!-- end col -->
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <h4><a href="#">Võ Bảo</a></h4>
