        ...
        <div class="col-sm-12 px-3">
            <x-admin.form.form method="POST" :cancelLink="route('admin.contact.show', [$khoa['slug']])"
                ...
                <div class="row">
                    ...
                    <x-admin.form.input :data="$contact" :col="3" :type="'text'" :label="'Phone'" :required="true" :placeholder="'Phone'" :fieldName="'phone'" />
                    ...
                    <x-admin.form.input :data="$contact" :col="3" :type="'text'" :label="'Hotline'" :required="true" :placeholder="'Hotline'" :fieldName="'hotline'" />
