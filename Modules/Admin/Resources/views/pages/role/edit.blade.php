                        ...
                        <div class="row">
                            ...
                            <div class="form-check col-md-12 px-1 pb-1">
                                ...
                                <div class="custom-control custom-switch form-control">
                                    <input type="checkbox" id="{{ $permission['id'].$permissionChildren['id'] }}" value="{{ $permissionChildren['id'] }}" class="custom-control-input" name="permission[]" {{ in_array($permissionChildren['id'], old('permission') ?? $role['permission_list'] ?? []) ? "checked" : '' }}>
